"use client";
// frontend/app/(company)/jobs/page.tsx
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#F8FAFC", fontFamily: "'DM Sans',-apple-system,sans-serif" }}>
      ...
      <aside style={{ width: 210, background: "#fff", borderRight: "0.5px solid #E2E8F0", display: "flex", flexDirection: "column", flexShrink: 0, position: "sticky", top: 0, height: "100vh", overflowY: "auto" }}>
        ...
        <div style={{ padding: "14px 6px 4px" }}>
          ...
          <SbLink href="/recruiter-jobs" icon="jobs" label="Jobs" active badge={jobs.length} />
        ...
        <div style={{ padding: "20px 24px", flex: 1 }}>
          ...
          {loading ? (
            ...
            <div style={{ background: "#fff", border: "0.5px solid #E2E8F0", borderRadius: 12, overflow: "hidden" }}>
              {/* Table header */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 120px 100px 80px 120px", gap: 12, padding: "10px 20px", borderBottom: "0.5px solid #F1F5F9", background: "#F8FAFC" }}>
              ...
              {filtered.map((job, i) => {
                ...
                return (
                  <div key={job.id} className="jr" style={{ display: "grid", gridTemplateColumns: "1fr 120px 100px 80px 120px", gap: 12, padding: "13px 20px", borderBottom: i < filtered.length - 1 ? "0.5px solid #F8FAFC" : "none", alignItems: "center", transition: "background 0.1s" }}>
                    ...
                    {/* Location */}
                    <p style={{ fontSize: 12, color: "#475569", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{job.location || "Remote"}</p>
                    {/* Type */}
                    <span style={{ fontSize: 10, fontWeight: 500, padding: "3px 9px", borderRadius: 20, background: "#EEF2FF", color: "#4338CA", whiteSpace: "nowrap", width: "fit-content" }}>
                      {job.job_type}
                    </span>
                    {/* Status */}
